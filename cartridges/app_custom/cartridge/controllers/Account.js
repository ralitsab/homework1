...
server.get(
    ...
    var CustomAttributes = require('dw/object/CustomAttributes');
        ...
        profileForm.customer.interest.value = customer.profile.custom.interest; 
        profileForm.customer.countryofresidence.value = customer.profile.custom.countryofresidence;
...
server.post(
    ...
    function (req, res, next) {
        ...
        var result = {
            ...
            interest: profileForm.custom.interest.htmlValue,
            countryofresidence: profileForm.countryofresidence.interest.htmlValue,
            profileForm: profileForm
        };
